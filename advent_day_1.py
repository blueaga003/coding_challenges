...
if __name__ == '__main__':
    ...
    print("HASH:", hash_list(numbers))
    print("HASH: ", time.time() - start_time)

    start_time = time.time()
    print("SORT:", max_sort_algorithm(numbers))
